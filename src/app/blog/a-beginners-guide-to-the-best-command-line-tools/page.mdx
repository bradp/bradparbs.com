...
import imageCli from './cli.png'
import imageBanner from './beginners-guide-to-best-command-line-tools-header.png'
import imageAgSearch from './ag-search.png'
import imageBrewInstallZsh from './brew-install-zsh.png'
import imageMyDotfiles from './my-dotfiles.png'
...
<Image src={imageCli} alt="command line" />
...
<Image src={imageAgSearch} alt="ag search" />
...
<Image src={imageMyDotfiles} alt="my dotfiles" />
