...
import imageVagrant from './vagrant.png'
import imageVvv from './vvv.png'
import imageVv from './vv.png'
import imageVvTerminal from './vv-terminal.png'
...
<Image src={imageVagrant} alt="Vagrant" />
