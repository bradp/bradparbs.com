        ...
        <div className="mx-auto max-w-2xl">
          {previousPathname && (
            <button
              ...
              className="group mb-8 flex h-10 w-20 items-center justify-center rounded-full bg-white shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 transition dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0 dark:ring-white/10 dark:hover:border-zinc-700 dark:hover:ring-white/20 lg:absolute lg:-left-5 lg:-mt-2 lg:mb-0 xl:-top-1.5 xl:left-0 xl:mt-0"
            >
          ...
          <article>
            <header className="flex flex-col">
              ...
              <h2 className="mt-4 text-base font-semibold text-zinc-400 dark:text-zinc-500">
