...
Card.Cta = function CardCta({ children }) {
  return (
    <div aria-hidden="true" className="relative z-10 mt-4 flex items-center text-sm font-medium text-pink-500">
      {children}
...
Card.Eyebrow = function CardEyebrow({ as, decorate = false, className, children, ...props }) {
  ...
  return (
    <Component
      className={clsx(
        className,
        'relative z-10 order-first mb-1 flex items-center text-sm text-zinc-400 dark:text-zinc-500',
        decorate && 'pl-1.5',
      )}
      {...props}
    >
