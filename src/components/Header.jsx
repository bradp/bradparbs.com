...
import avatarImage from '@/images/brad-parbs.png'
...
function Avatar({ large = false, className, ...props }) {
  return (
    <Link
      href="/"
      aria-label="Home"
      className={clsx(className, 'group pointer-events-auto flex items-center gap-2')}
      {...props}
    >
      <Image
        src={avatarImage}
      ...
      />
      <div className="min-w-max text-xl font-light text-zinc-600 group-hover:text-pink-500 dark:text-zinc-400 dark:group-hover:text-pink-400">
        Brad Parbs
      </div>
    </Link>
  )
